"""
Example: How to call the trademe-co-nz-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/trademe-co-nz-scraper
...
def run_actor():
    """Run the trademe-co-nz-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/trademe-co-nz-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.trademe.co.nz/a/motors/cars/mitsubishi"}],
            "maxItems": 5,
        }
    )
